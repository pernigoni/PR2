public class TestIndexedLibrary 
{
    public static void main (String[] args) 
    {
        ...
        assert myBk3.getGenre().equals("fiction"); // per verificare la versione estesa di book
        ...
        assert myIL.getByIndex(2).equals(myBk2); // per verificare la versione estesa di library, la correttezza dell'assert dipende dalla specifica implementazione dell'indicizzazione
    }
}